...
<tags:master pageTitle="Product List">
    ...
    <c:if test="${not empty errors}">
        <div class="error">An error occurred while updating the cart.</div>
    </c:if>
    <table>
        <thead>
        <tr>
        ...
        <c:forEach var="product" items="${products}" varStatus="status">
            <tr>
                <td><img class="product-tile" src="${product.imageUrl}" alt="product-image"></td>
                <td>
                ...
                <td>
                    ...
                    <input id="quantity" form="addItemToCart" name="quantity"
                           value="${not empty error ? paramValues['quantity'][status.index] : 1}" pattern="\d+"
                           required>
    ...
    <form method="post" id="addItemToCart"></form>
